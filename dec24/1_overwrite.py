# in this code , every time a new code is overwritten rather than printing in same file
...
try:
    while True:
        ...
        if query in exit_words:
            ...
            with open('result.io', 'w') as file:  # Use 'w' mode to overwrite the existing content
