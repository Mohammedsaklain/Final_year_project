...
def GPT(query, board_type):
    messages = [
        ...
        {"role": "user", "content": f"I am programming an {board_type}. {query}"}
    ]
...
def main():
    ...
    board_type = input("Please enter the board type (Arduino Uno, Arduino Nano, ESP32): ").lower()
